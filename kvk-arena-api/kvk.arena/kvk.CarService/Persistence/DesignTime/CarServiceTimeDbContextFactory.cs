...
namespace kvk.CarService.Persistence.DesignTime;

public class CarServiceTimeDbContextFactory : IDesignTimeDbContextFactory<CarServiceDbContext>
{
    public CarServiceDbContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseNpgsql(connectionString, b => b.MigrationsAssembly("kvk.CarService"));
        ...
        return new CarServiceDbContext(optionsBuilder.Options, tenantService, logger, null);
    }
