...
namespace Kvk.Cafe.Persistence.DesignTime;

public class CafeTimeDbContextFactory : IDesignTimeDbContextFactory<CafeDbContext>
{
    public CafeDbContext CreateDbContext(string[] args)
    {
        ...
        while (current != null)
        {
            ...
            if (File.Exists(candidate))
            {
                ...
                try
                {
                    ...
                    {
                        if (cs.TryGetProperty("CafeConnection", out var gymEl) &&
        ...
        optionsBuilder.UseNpgsql(connectionString, b => b.MigrationsAssembly("kvk.Cafe"));
        ...
        return new CafeDbContext(optionsBuilder.Options, tenantService, logger, null);
    }
