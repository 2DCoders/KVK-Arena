...
public class SaloonDbContextFactory : IDesignTimeDbContextFactory<SaloonDbContext>
{
    ...
    {
        var optionsBuilder = new DbContextOptionsBuilder<SaloonDbContext>();
        ...
        while (current != null)
        {
            ...
            if (File.Exists(candidate))
            {
                ...
                try
                {
                    ...
                    {
                        if (cs.TryGetProperty("SaloonConnection", out var gymEl) &&
        ...
        optionsBuilder.UseNpgsql(connectionString, b => b.MigrationsAssembly("kvk.Saloon"));
