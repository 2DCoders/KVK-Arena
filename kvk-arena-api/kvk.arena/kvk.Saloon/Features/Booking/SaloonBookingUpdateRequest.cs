...
public class SaloonBookingUpdateRequest
{
    ...
    public List<SaloonBookingServiceUpdateRequest> Services { get; set; } = new();
}

public class SaloonBookingServiceUpdateRequest
{
    public Guid? Id { get; set; }
