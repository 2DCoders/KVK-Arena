  ...
  return (
    ...
    >
      <div className="sticky top-0 min-h-screen overflow-hidden bg-[#05070b]">
        ...
        <div className="relative z-10 mx-auto grid min-h-screen w-full max-w-[1500px] grid-cols-1 items-center gap-8 px-5 py-20 sm:px-8 lg:grid-cols-[0.82fr_1.18fr] lg:gap-14 lg:px-12 xl:px-16">
          {/* Left content */}
          <div className="relative z-20 order-2 flex items-center lg:order-1">
            ...
            >
              <div className="mb-7 flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-[#296BE1]/30 bg-[#296BE1]/10 text-[#4d87ef] shadow-[0_0_35px_rgba(41,107,225,0.15)]">
                  <CurrentIcon
                    size={22}
                    strokeWidth={2}
                  />
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.25em] text-[#4d87ef]">
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                {currentService.features.map((feature) => (
                  <div
                    key={feature}
                    className="group flex items-center gap-3 rounded-2xl border border-white/[0.08] bg-white/[0.04] px-3.5 py-3.5 backdrop-blur-xl transition duration-300 hover:border-[#296BE1]/30 hover:bg-[#296BE1]/[0.08]"
                  >
          ...
          <div className="relative order-1 flex min-h-[42vh] items-center justify-center lg:order-2 lg:min-h-[78vh]">
            <div className="absolute inset-x-10 bottom-3 h-24 rounded-full bg-[#296BE1]/15 blur-[60px]" />

            <div className="relative h-[42vh] w-full overflow-hidden rounded-[2rem] border border-white/10 bg-white shadow-[0_35px_100px_rgba(0,0,0,0.55),0_0_70px_rgba(41,107,225,0.1)] sm:h-[48vh] lg:h-[78vh] lg:rounded-[3rem]">
              <canvas
                ref={canvasRef}
              ...
              {/* Scene badge */}
              <div className="pointer-events-none absolute pt-5 left-4 top-4 rounded-2xl border border-black/[0.07] bg-black/80 px-4 py-3 shadow-xl backdrop-blur-xl sm:left-6 sm:top-6">
              ...
              <div className="pointer-events-none absolute bottom-4 left-4 right-4 flex items-center justify-between rounded-2xl border border-black/[0.06] bg-black/80 px-4 py-3 shadow-xl backdrop-blur-xl sm:bottom-6 sm:left-6 sm:right-6">
