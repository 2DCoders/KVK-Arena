    ...
    return (
        <section className="relative overflow-hidden bg-linear-to-b from-slate-950 to-slate-900 py-5 lg:py-15">
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div
                    ref={railRef}
                    className="mt-5 flex gap-6 overflow-x-auto scroll-smooth pb-6 pr-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
                >
                    {plans.map((plan) => (
                        <article
                            key={plan.name}
                            className={`relative min-w-[320px] flex-1 basis-[320px] rounded-2xl border p-6 shadow-[0_18px_50px_rgba(0,0,0,0.2)] transition duration-300 hover:-translate-y-1 sm:min-w-[360px] sm:basis-[360px] ${plan.featured
                        ...
                        >
                            ...
                            <button
                                type="button"
                                className={`mt-6 inline-flex w-full items-center justify-center rounded-md px-5 py-3 text-sm font-semibold transition ${plan.featured
