          ...
          {isLoading && (
            <div className="mt-10 flex gap-4 overflow-hidden pb-7 sm:mt-12 sm:gap-5">
              {[1, 2, 3].map((item) => (
                <div
                  key={item}
                  className="w-[88vw] shrink-0 overflow-hidden rounded-[24px] border border-slate-200 bg-white shadow-sm sm:w-[360px] sm:rounded-[28px] lg:w-[380px]"
                >
                  ...
                  {visiblePackages.map(
                    (item, packageIndex) => {
                      ...
                      return (
                        <article
                          key={item.id}
                          className="group relative flex w-[88vw] shrink-0 snap-start flex-col overflow-hidden rounded-[24px] border border-slate-200 bg-white shadow-[0_20px_55px_rgba(15,23,42,0.08)] transition-all duration-500 hover:-translate-y-1.5 hover:border-blue-200 hover:shadow-[0_26px_70px_rgba(20,115,255,0.14)] sm:w-[360px] sm:rounded-[28px] lg:w-[380px]"
                        >
                          {/* Image */}
                          ...
                          <div className="flex flex-1 flex-col p-5 sm:p-6">
                            <div>
                              <h3
                                className="line-clamp-1 text-xl font-semibold tracking-[-0.025em] text-slate-950 sm:text-2xl"
                                title={item.name}
                              >
                                {item.name}
                              </h3>
                            ...
                            <div className="mt-5 flex flex-1 flex-col border-t border-slate-100 pt-5">
                              ...
                              0 ? (
                                <div className="mt-4 min-h-[144px] space-y-3">
                                  {item.services
                                    .slice(0, 4)
                                    .map(
                                      (
                                ...
                                <div className="mt-4 flex min-h-[144px] items-center justify-center">
