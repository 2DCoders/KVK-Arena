import MiddleImg from "@/assets/coffee2.png";
import {
  Bean,
  Coffee,
  HeartHandshake,
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-5 sm:px-8 lg:px-12">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-[#74645a] sm:text-base">
            We bring together quality ingredients, thoughtful preparation and
            a welcoming atmosphere to create memorable moments in every cup.
          </p>
        </div>

        {/* Content */}
        <div className="mt-16 grid items-center gap-12 lg:grid-cols-[1fr_0.9fr_1fr] lg:gap-8 xl:gap-12">
          {/* Left feature list */}
          ...
          <div className="relative mx-auto flex w-full max-w-[430px] items-center justify-center">
            ...
            <div className="relative flex min-h-[420px] w-full items-center justify-center sm:min-h-[500px]">
              ...
              <img
                src={MiddleImg}
                alt="Iced coffee with milk splash"
                className="relative z-10 max-h-[440px] w-auto max-w-full object-contain drop-shadow-[0_28px_34px_rgba(81,45,27,0.18)] sm:max-h-[500px]"
              />

              <div className="absolute left-4 top-12 hidden rounded-2xl border border-[#ead8c8] bg-white/90 px-4 py-3 shadow-[0_16px_40px_rgba(80,48,29,0.1)] backdrop-blur-md sm:block">
              ...
              <div className="absolute bottom-14 right-0 hidden rounded-2xl border border-[#ead8c8] bg-white/90 px-4 py-3 shadow-[0_16px_40px_rgba(80,48,29,0.1)] backdrop-blur-md sm:block">
                <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#a76841]">
                  Premium quality
                </p>
                <p className="mt-1 text-sm font-bold text-[#2c1a12]">
        ...
        {/* Bottom statistics */}
        <div className="mt-16 grid overflow-hidden rounded-[2rem] border border-[#eaded3] bg-white shadow-[0_22px_65px_rgba(83,51,31,0.08)] sm:grid-cols-3">
