...
export default function SignupModal({ open, onClose }: SignupModalProps) {
  ...
  const validate = () => {
    ...
    if (!confirm) newErrors.confirm = "You must confirm before continuing";
      ...
      {loading && (
        <div className="fixed inset-0 z-[9999999999] flex items-center justify-center bg-black/60 backdrop-blur-md">
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-sm text-white font-medium">Registering...</p>
          </div>
        </div>
      )}
          ...
          <div className="relative hidden md:block h-full">
            ...
            <div className="relative flex h-full flex-col justify-end p-10 text-white">
              ...
              <p className="mt-4 max-w-sm text-sm text-gray-200">
                Join expert trainers, modern equipment, and premium fitness
                programs.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-white via-slate-50 to-slate-100 p-6 md:p-10 max-h-[95vh] overflow-y-auto">
            ...
            {authMode === "signup" && step === 1 && (
              <>
                ...
                {/* CONFIRM CHECKBOX */}
                <div className="mt-6 flex items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white p-4">
                  <input
                    type="checkbox"
                    checked={confirm}
                  ...
                  <p className="text-xs text-slate-600">
                    I confirm that all information is correct and understand
                    ...
                    .map((plan) => {
                      ...
                      return (
                        <button
                          ...
                          className={`text-left rounded-2xl border p-4 cursor-pointer transition-all duration-200 hover:shadow-md ${
                            isSelected
