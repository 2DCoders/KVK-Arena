        ...
        <div
          className={
            isScrolled
              ...
              : "relative mx-auto flex h-16 max-w-295 items-center justify-between overflow-hidden rounded-full border border-white/30 bg-[linear-gradient(135deg,#000000,#111111,#1b2f39)] px-4 py-1.5 backdrop-blur-2xl transition-all duration-500 lg:h-20 lg:px-8 lg:py-2"
          }
        >
          {/* Glow */}
          <div
