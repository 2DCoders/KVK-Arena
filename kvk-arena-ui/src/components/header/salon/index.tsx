          ...
          className={
            isScrolled
              ? `
                  ...
                  border
                  border-[#7C3AED]/25
                  bg-[linear-gradient(135deg,rgba(9,5,15,0.96),rgba(20,11,36,0.94),rgba(53,21,90,0.88))]
                  px-4 py-1.5
                  shadow-[0_18px_50px_rgba(9,5,15,0.60)]
                  backdrop-blur-md
                  transition-all
                  duration-500
                  sm:w-[calc(100%-2rem)]
              ...
              : `
                  ...
                  border
                  border-white/20
                  bg-[linear-gradient(135deg,rgba(9,5,15,0.94),rgba(20,11,36,0.88),rgba(53,21,90,0.82),rgba(124,58,237,0.40))]
                  px-4 py-1.5
                  shadow-[0_18px_50px_rgba(15,7,26,0.30)]
                  backdrop-blur-2xl
                  transition-all
                  duration-500
                  sm:w-[calc(100%-2rem)]
            ...
            className={
              isScrolled
                ? `
                    pointer-events-none
                    absolute inset-0
                    bg-[radial-gradient(circle_at_top_left,rgba(124,58,237,0.16),transparent_32%),radial-gradient(circle_at_top_right,rgba(255,255,255,0.04),transparent_34%)]
                  `
                : `
                    pointer-events-none
                    absolute inset-0
                    bg-[radial-gradient(circle_at_top_left,rgba(167,139,250,0.16),transparent_36%),radial-gradient(circle_at_top_right,rgba(255,255,255,0.08),transparent_30%)]
                  `
            }
          />
            ...
            >
              <button
                ...
                className="
                  ...
                  font-extrabold
                  text-[#0B0612]
                  shadow-[0_12px_32px_rgba(109,40,217,0.22)]
                  transition
                  hover:-translate-y-0.5
                  hover:shadow-[0_16px_40px_rgba(109,40,217,0.32)]
                "
              >
                Visit Us
              </button>
      ...
      >
        <aside
          ...
          className={`
            ...
            border-l
            border-[#4C1D95]/25
            bg-[linear-gradient(180deg,#09050F_0%,#140B24_40%,#24103D_72%,#35155A_100%)]
            p-6
          ...
          <nav className="relative z-10 flex min-w-0 flex-col gap-5 overflow-x-hidden">
            ...
            <a
              ...
              className="
                ...
                transition
                hover:-translate-y-0.5
                hover:shadow-[0_16px_36px_rgba(109,40,217,0.30)]
              "
            >
              Visit Us
            </a>
